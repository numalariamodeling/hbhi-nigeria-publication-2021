...
# - Requires IPTi_adjustment_U5.csv and  IPTi_adjustment_Uall.csv to be in the simulation output folder if scenario_adjustement_info.csv has IPTi=TRUE
...
ipti_adj_Uall_filename = paste(sim_output_filepath, '/IPTi_adjustment_Uall.csv', sep='')
ipti_adj_U5_filename = paste(sim_output_filepath, '/IPTi_adjustment_U5.csv', sep='')
