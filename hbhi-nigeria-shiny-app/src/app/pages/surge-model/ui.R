...
# LGAParamsPanel <- function () {
#   fluidRow(
#     column(12, shiny::h3('LGA Intervention Inputs', style='margin-top: 0;')))
#   fluidRow(
#      column(width = 12,
# 		shiny::selectInput(
...
# 		),
# 	
# 		column(width = 12, offset = 3, shiny::selectInput(
# 			inputId = 'yearInput',
# 			label = "Year",
...
# 		
# 		
# 		column(width = 12, offset = 6, shiny::selectInput(
# 			inputId = 'varType',
# 			label = 'Intervention Type',
# 			choices =  INPUT_PARAM_DESCRIPTIONS[['interventions']],
# 			multiple = TRUE)
# 		)
# 	)
