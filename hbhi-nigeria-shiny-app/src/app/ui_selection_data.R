INPUT_PARAM_DESCRIPTIONS <- list(
  ...
  year = c("", 2020:2030),
  interventions = c("Case management - uncomplicated", 'Insecticide treated net kill rate', 'Insecticide treated net block rate', 'Insecticide treated net coverage', 'Seasonal malaria chemoprevention', 'Intermittent preventive treatment in pregnancy', 'Intermittent preventive treatment in infants', 'ALL'),
