...
def calc_ann_nation_indicators(data, population, U5 = False):
    ...
    data['PfPR' + channel_suffix] = calculate_rate(data, 'positives' + channel_suffix, population + channel_suffix)
    data['incidence' + channel_suffix] = calculate_rate(data, 'cases' + channel_suffix, population + channel_suffix, True)
    data['death_rate_1' + channel_suffix] = calculate_rate(data, 'deaths_1' + channel_suffix, population + channel_suffix, True)
    data['death_rate_2' + channel_suffix] = calculate_rate(data, 'deaths_2' + channel_suffix, population + channel_suffix, True)
...
def rescale_age_metrics(data, population, U5 = False):
    if U5 == True:
        ...
        channel_suffix = '_all_ages'
        data['num_mLBW'] = data['mLBW_births'] * data[population + channel_suffix] / data['Population' + channel_suffix]
        data['num_mStillbirths'] = data['MiP_stillbirths'] * data[population + channel_suffix] / data['Population' + channel_suffix]
    data['positives' + channel_suffix] = data['PfPR' + channel_suffix] * data[population + channel_suffix]
    data['cases' + channel_suffix] = data['New_clinical_cases' + channel_suffix] * data[population + channel_suffix] / data['Population' + channel_suffix]
    data['deaths_1' + channel_suffix] = data['total_mortality_1' + channel_suffix] * data[population + channel_suffix] / data['Population' + channel_suffix]
    data['deaths_2' + channel_suffix] = data['total_mortality_2' + channel_suffix] * data[population + channel_suffix] / data['Population' + channel_suffix]
